...
description: "Reverie offers a free tier to help developers explore Speech and Text APIs with flexible access, and provides detailed usage analytics to monitor and optimize API consumption."
---

### Free Tier (1 Year Expiry)
Upon signing up, every developer account receives:
- **5 hours of free Speech-to-Text (Streaming)** usage
- **5 hours of free Speech-to-Text (File)** usage
- **10,000 characters of free Text-to-Speech (TTS)** generation
- **10,000 characters of free Translation** usage
- **10,000 characters of free Transliteration** usage
...
1. Visit the [**Pricing Page**](https://revup.reverieinc.com/pricing?utm_source=documentation&utm_medium=website&utm_campaign=revup_signup) on RevUp
...
### Rate Limits
- **Concurrency limit (free tier)**: Up to 5 concurrent API connections/sessions.
...
- **Remaining Quota**: Monitor your remaining Speech and Text APIs usage at a glance.
- **Detailed Usage Logs**:
    - View API-wise breakdown
